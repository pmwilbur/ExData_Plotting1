...
plot(df2$Date,df2$Global_active_power,type="l",pch="'",xlab="",ylab="Global Active Power (Kilowatts)")

plot(df2$Date,df2$Voltage,pch="'",xlab="date/time",ylab="Voltage")
lines(df2$Date,df2$Voltage,lwd=2)
...
plot(df2$Date,df2$Global_reactive_power,type="l",pch="'",xlab="date/time",ylab="Global Reactive Power")
